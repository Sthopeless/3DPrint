...
#define STRING_CONFIG_H_AUTHOR "(Sthope, AM8-RAMPS 1.6)" // Who made the changes.
...
#define WELCOME_MSG "         AM8"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "0ee9adb9-9702-4bc5-af93-0e111d7a833a"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sthope-PID
  //(measured after M106 S255 with M303 E0 S220 C8)
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Sthope HeatbedPID
  #define DEFAULT_bedKp 350.58
  #define DEFAULT_bedKi 47.55
  #define DEFAULT_bedKd 646.21
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 3657 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -00.85   // Z offset: -below +above  [the nozzle]
