...
#define STRING_CONFIG_H_AUTHOR "(Putxi, Anet A6 ABL)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "         Putxi"
#define WELCOME_MSG "        Putxi"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "fbecf259-5ce9-4a96-8e30-7100b0d5cd8e"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Sthope
  #define DEFAULT_bedKp 526.13
  #define DEFAULT_bedKi 100.35
  #define DEFAULT_bedKd 689.62
 ...
 *
 * Note that if  is enabled, saved values will override these.
 */
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 400, 139.40}
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define BACK_PROBE_BED_POSITION 161
